...
export default function ChatItem({ icon, message, role }: ChatItemI) {
  if (role == "user") {
    return (
      <div className="grid max-w-5xl grid-cols-[5%__90%] py-5 bg-DarkGray items-center  w-fit   px-4 gap-2 rounded">
  ...
  return (
    <div className="w-full max-w-5xl flex items-center gap-3 py-6 pl-5 md:pl-[100px]   ">
      <div className="w-full grid grid-cols-[5%__1fr] gap-6 md:gap-1 items-start">
        ...
        <p className="text-white mt-6 flex-grow leading-9 pr-5  font-normal text-[15px]">{message}</p>
